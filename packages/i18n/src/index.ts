...
export const UI_NOTES: Record<string, string> = {
  ...
  ui_ticket_no_reply_warning: "Shown on a ticket with no channel behind it. The desk genuinely cannot send a message to a logged phone call, and saying so is the point — the alternative is a composer that silently fails.",
